...
import time
import numpy as np
from picarx_improved import Picarx   # ✅ car control
...
def gen_frames():
    while True:
        ...
        # ===== Steering ONLY (no driving yet) =====
        if offset is not None:
            angle = STEER_SCALE * offset
...
@app.route("/")
def index():
    return "<h3>Annotated Line Stream (Steering Only)</h3><img src='/video'>"
